...
var Properties = {
    ...
    "animation-play-result"          : { multi: "running | paused", comma: true },
    ...
    "-moz-animation-play-result"          : { multi: "running | paused", comma: true },
    ...
    "-ms-animation-play-result"          : { multi: "running | paused", comma: true },
    ...
    "-webkit-animation-play-result"          : { multi: "running | paused", comma: true },
    ...
    "-o-animation-play-result"          : { multi: "running | paused", comma: true },        
...
CSSLint.addRule({
    ...
    init: function (parser, reporter) {
        ...
        compatiblePrefixes = {
            ...
            "animation-play-result"       : "webkit moz",
